  ...
  return (<>
    ...
    <div className="row mt-5 mb-5">
        ...
        <div className="col-lg ml-lg-5 text-center">
          <h2>Florgon Notes</h2>
          <p>Notes taking website, and application (Not yet released). Absolutely free and open. Supports markdown, and other cool stuff.</p>
          <Link href="https://notes.florgon.space"><a className="btn btn-outline-secondary shadow">Open website</a></Link>
        </div>
    </div>
    <div className="row mt-5 mb-5">
        <div className="col-lg ml-lg-5 text-center mb-3">
          <h2>Gatey</h2>
          <p>Error logging service for developers. Allows you to collect and analyse your application crash reports and problems.</p>
          <Link href="https://gatey.florgon.space"><a className="btn btn-outline-secondary shadow">Open website</a></Link>
        </div>
        <div className="col-lg ml-lg-5 text-center mb-3">
          <h2>Other</h2>
